      ...
      <div className="p-4">
        <div className="flex items-start gap-2 mb-2">
          <div className="flex-1 min-w-0">
            ...
            >
              {lang === "en" ? (panel.title_en || panel.title_fa) : (panel.title_fa || panel.title_en)}
            </h3>
          </div>
        </div>
        ...
        {(lang === "en" ? visibleFields.hall_en : visibleFields.hall_fa) &&
          (panel.hall_en || panel.hall_fa) && (
          <div
            className="flex items-center gap-1.5 text-xs mb-2"
            style={{ color: "var(--text-muted)" }}
          >
            <span>📍</span>
            <span>{lang === "en" ? (panel.hall_en || panel.hall_fa) : panel.hall_fa}</span>
          </div>
        )}
        ...
        {(lang === "en"
          ? visibleFields.description_en && (panel.description_en || panel.description_fa)
          ...
          >
            {lang === "en" ? (panel.description_en || panel.description_fa) : panel.description_fa}
          </p>
        )}
...
export default function PanelsClient({ title, subtitle, title_en, subtitle_en, isHomeContext = false, showBack = true }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 pt-4">
        <PageHeader title={title} subtitle={subtitle} title_en={eventNameEn || title_en} subtitle_en={subtitle_en} isHomeContext={isHomeContext} showBack={showBack} />
